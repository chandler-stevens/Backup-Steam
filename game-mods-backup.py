...
def backup():
    ...
    # Find all games in source that have mods
    src_games_all = []
    src_games = []
    zombie_games = []
    ask_user = False
    print_and_log("\n--------------------------------------------------------", True)
    print_and_log("List of Installed Games with Mods:", True)
    print_and_log("--------------------------------------------------------", True)
    for game in next(walk(source))[1]:
        src_games_all.append(game)
        if path.exists(source + "/" + game + "/" + my_mods):
    ...
    print_and_log("--------------------------------------------------------", True)
    print_and_log("Total Installed Games with Mods: " + str(len(src_games)), True)
    if len(src_games) <= 0:
        ask_user = True
        print_and_log("\nWARNING: No game folders with a " + my_mods + " sub-folder exist currently!")
    ...
    stored_games = 0
    print_and_log("\n--------------------------------------------------------", True)
    print_and_log("List of Stored/Uninstalled Games with Mods:", True)
    print_and_log("--------------------------------------------------------", True)
    ...
    print_and_log("--------------------------------------------------------", True)
    print_and_log("Total Stored/Uninstalled Games with Mods: " + str(stored_games), True)
    ...
    # for game in source:
    print_and_log("\n--------------------------------------------------------")
    print_and_log("                Backing up Mods...")
    print_and_log("--------------------------------------------------------")
    for game in src_games:
        src = source + "/" + game + "/" + my_mods
        dest = destination + "/" + game + "/" + my_mods
        ...
        if game not in dest_games:
            print_and_log(" + Backing up Mods for a new Game: " + game)
    ...
    print_and_log("\nTotals:" +
                  ...
                  "    New games with mods: " + str(new_game_total))
    end_backup(0)
